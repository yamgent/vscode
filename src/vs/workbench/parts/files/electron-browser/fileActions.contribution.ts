...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
	...
	order: 35,
	command: {
		id: HELLO_WORLD_COMMAND_ID,
		title: nls.localize('hw', "Hello World")
	},
	when: ResourceContextKey.HasResource
});
