...
class WelcomePage {
	...
	constructor(
		...
		this.notificationService.prompt(Severity.Info, localize('welcomePage.telemetryNotice', "Help improve VS Code by allowing Microsoft to collect usage data. Read our [privacy statement]({0}) and learn how to [opt out]({1}).", privacyUrl, readMoreUrl), [localize('telemetryNotice.readMore', "Read More")])
